import { loadScene, loadResources } from './loader'
...
describe('Advanced scene loader', () => {
    it('should load a scene', async () => {
        ...
        expect(character).toBeInstanceOf(ScenarioCharacter)
        ...
        //The character should not have a gltf yet
        expect(character.gltf).toBeUndefined()
        ...
        expect(resources.models3d).toEqual(["models/test.gltf", "models/scene.gltf"])
